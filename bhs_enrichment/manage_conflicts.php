...
$result = $db->query("SELECT student_id, date, reason FROM requests WHERE employee_id = '00001' AND date = '2016-10-7'");
?>
<?php
if(isset($_POST['r_id'])){
	
	$sql = "UPDATE requests SET priority='1' WHERE id='".$_POST['r_id']."'";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar" style="color: gold;">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="my_admin.php">Conflicts</a></li> 
		<li><a href="my_history.php">History</a></li> 
      </ul>
      <ul class="nav navbar-nav navbar-right">
		<li><a href="change_pw.php"><span class="glyphicon glyphicon-cog"></span> Change Password</a></li>
...
<div class="container">
  <h2>Conflicts</h2>
  This is a list of students that have been called to Enrichment. 
  ...
  <table id="mytable1" class="table table-bordered table-striped table-hover" > 
            ...
            <tbody>
	<?php 
	$result = $db->query("SELECT request_id, student_id, reason FROM requests WHERE employee_id = '00001' AND date = '".$dates[$i]."'");
	...
	?>		
                ...
                <tr class='clickable-row' data-toggle="modal" data-target="#myModal" data-rid = <?php echo $row["request_id"]?> data-sid= <?php echo $row["student_id"] ?> data-lname = <?php echo $stu["lname"] ?> data-fname=<?php echo $stu["fname"] ?> > 
					...
					<td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirmModal">Mark Priority</button></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to give this request priority?</p>
